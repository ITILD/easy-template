...
define(['./when-7be8a9d0', './Check-95b5c836', './Math-1bdfdd19', './Cartesian2-e1152338', './Transforms-48138b95', './RuntimeError-c01fec73', './WebGLConstants-daaa9be0', './AttributeCompression-e971545c', './IndexDatatype-a017e02f', './IntersectionTests-5a95a776', './Plane-22c766bf', './createTaskProcessorWorker', './EllipsoidTangentPlane-3e0801c1', './OrientedBoundingBox-2bcc8472', './Color-26decb30'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
